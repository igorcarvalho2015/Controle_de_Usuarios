...
class SSP {
     ...
     */
    static function data_output($columns, $data, $primaryKey = null, $acao = true) {
        $out = array();
		$chave = '';
     ...
     */
    static function simple($request, $conn, $table, $primaryKey, $columns, $query = null, $acao = true) {
        $bindings = array();
        $db = self::db($conn);
        ...
        return array(
            ...
            "data" => self::data_output($columns, $data, $primaryKey, $acao)
        );
    }
