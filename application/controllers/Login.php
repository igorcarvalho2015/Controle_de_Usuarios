...
class Login extends CI_Controller {
    ...
    public function valida_login() {
        ...
        if ($retorno['RETORNO']) { //validou		
            ...
            $this->session->set_userdata("id_Usuario", $rows['idUsuario']);
            $this->session->set_userdata("idCargo", $rows['idCargo']);
            $this->session->set_userdata("strNome", $rows['strNome']);
            $this->salva_logs();
    ...
    private function salva_logs() {
        $arr_log['acao'] = 'Usuario logou no sistema';
